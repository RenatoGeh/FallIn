...
namespace amb {
	...
	DrawableImage::DrawableImage(const std::string& fileName, const ugdk::math::Vector2D& size) : texture_(Texture::CreateFromFile(fileName)), drawable_(texture_, size), deletesTexture_(true) {}

	DrawableImage::DrawableImage(Texture* texture) : texture_(texture), drawable_(texture_), deletesTexture_(false) {}

	DrawableImage::DrawableImage(Texture* texture, const ugdk::math::Vector2D& size) : texture_(texture), drawable_(texture_, size), deletesTexture_(false) {}
